...
class Song(models.Model):
    ...
    generation_status = models.CharField(max_length=20, choices=GenStatus.choices, default=GenStatus.PENDING)
    privacy_status = models.CharField(max_length=20, choices=Privacy.choices, default=Privacy.PRIVATE)
...
class Invitation(models.Model):
    share_link = models.ForeignKey(ShareLink, on_delete=models.CASCADE, related_name='invitations')
    email = models.EmailField()
    status = models.CharField(max_length=20, default='pending')  # เช่น pending, accepted
